...
use packages\base\{IO\Directory, IO\File, IO\Node};
...
abstract class Storage implements \JsonSerializable {
	...
	public static function fromArray(array $data): self {
		...
		switch ($data['@class']) {
			case "local": $data['@class'] = Storage\LocalStorage::class; break;
		}
		...
		return call_user_func(array($data['@class'], __FUNCTION__), $data);
	}
