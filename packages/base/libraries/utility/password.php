...
class password
{
     ...
     *
     * @see http://php.net/manual/en/function.hash-equals.php#115664
     *
    ...
    public static function hash_equals($known_string, $user_string)
    {
        ...
        if (true !== is_string($known_string)) {
    ...
    public static function generate(int $length = 10, bool $number = true, bool $az = true, bool $AZ = true, bool $special = false): string
    {
