...
class hdate implements date_interface {
	...
	public static function format($type,  $maket= "now"): string {
		...
		while ($i < strlen($type)) {
			...
			switch ($subtype) {
				...
				case "D":
					$result1 .= date("D", $need);
					if ($result1 == "Sat") $result1 = "سبت";
					elseif ($result1 == "Sun") $result1 = "أحد";
					elseif ($result1 == "Mon") $result1 = "اثنين";
					elseif ($result1 == "Tue") $result1 = "ثلاثاء";
					elseif ($result1 == "Wed") $result1 = "أربعاء";
					elseif ($result1 == "Thu") $result1 = "خميس";
					elseif ($result1 == "Fri") $result1 = "جمعة";
					$result .= $result1;
					break;
    			case "F":
				...
				case "l":
					$result1 = date("l", $need);
					if ($result1 == "Saturday") $result1 = "السبت";
					elseif ($result1 == "Sunday") $result1 = "الأحد";
					elseif ($result1 == "Monday") $result1 = "الإثنين";
					elseif ($result1 == "Tuesday") $result1 = "الثلاثاء";
					elseif ($result1 == "Wednesday") $result1 = "الأربعاء";
					elseif ($result1 == "Thursday") $result1 = "الخميس";
					elseif ($result1 == "Friday") $result1 = "الجمعة";
					$result .= $result1;
					break;
				case "m":
					if ($hmonth<10) $result1 = "0" . $hmonth;
					else $result1 = $hmonth;
					if ($transnumber==1) $result .= self::Convertnumber2farsi($result1);
					else $result .= $result1;
					break;
				case "M":
					$result .= self::short_monthname($hmonth);break;
				case "n":
					$result1 = $hmonth;
					if ($transnumber==1) $result .= self::Convertnumber2farsi($result1);
					else $result .= $result1;
	...
	public static function isKabise(int $year = 0): bool {
		...
		return in_array($year % 30, array("2, 5, 7, 10, 13, 16, 18, 21, 24, 26, 29"));
	}
	public static function gregorianToHijri (int $year, int $month, int $day): array {
		...
		return array($year, $month, $day, $dayinyear);
	}
	...
	public static function monthname($month): string {
		switch($month) {
			...
			case('03'):return('ربیع‌الاول');break;
			case('04'):return('ربیع‌الثانی');break;
			case('05'):return('جمادی‌الاول');break;
			case('06'):return('جمادی‌الثانی');break;
			case('07'):return('رجب');break;
			case('08'):return('شعبان');break;
			case('09'):return('رمضان');break;
			case('10'):return('شوال');break;
	...
	public static function short_monthname($month): string {
		switch($month) {
			...
			case('03'):return('ر1');break;
			case('04'):return('ر2');break;
			case('05'):return('ج1');break;
			case('06'):return('ج2');break;
			case('07'):return('رج');break;
			case('08'):return('شع');break;
			case('09'):return('رم');break;
			case('10'):return('شو');break;
